...
$string['feedback_perfect_title'] = 'Outstanding!';
$string['feedback_perfect_desc'] = 'You remembered almost everything. You have mastered this material!';
$string['feedback_good_title'] = 'Very Good!';
$string['feedback_good_desc'] = 'You are doing great. Keep it up!';
$string['feedback_okay_title'] = 'Well Done!';
$string['feedback_okay_desc'] = 'You know the basics. A little more practice and you will be an expert.';
$string['feedback_learn_title'] = 'Keep Going!';
$string['feedback_learn_desc'] = 'Practice makes perfect. Just review the hard cards again soon.';
