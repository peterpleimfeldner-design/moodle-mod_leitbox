...
$string['leitbox:addinstance'] = 'Neues LeitBox hinzufügen';
$string['leitbox:view'] = 'LeitBox ansehen';
...
$string['completion_min_mastered_help'] = 'Gibt an, wie viele Karten Lernende in die letzte Box (Experten-Stapel) befördern müssen. Wichtig: Dieser Wert darf die Gesamtzahl der Karten in der Aktivität nicht überschreiten – andernfalls ist der Abschluss unerreichbar.';

$string['completion_all_mastered'] = 'Alle Karten gelernt';
$string['completion_all_mastered_desc'] = 'Lernende müssen ALLE Karten fehlerfrei meistern (alle Karten in den Experten-Stapel befördern)';
$string['completion_all_mastered_help'] = 'Wenn aktiviert, gilt diese Aktivität erst als abgeschlossen, wenn Lernende restlos alle importierten Karten in die finale Experten-Box bewegt haben.';
...
// Privacy metadata.
$string['privacy:metadata:leitbox_progress'] = 'Informationen über den Lernfortschritt bei LeitBox.';
$string['privacy:metadata:leitbox_progress:userid'] = 'Die Benutzer-ID.';
$string['privacy:metadata:leitbox_progress:cardid'] = 'Die Karten-ID.';
$string['privacy:metadata:leitbox_progress:box_number'] = 'Die Leitner-Box, in der sich die Karte aktuell befindet.';
$string['privacy:metadata:leitbox_progress:count_correct'] = 'Die Anzahl, wie oft der Benutzer die Karte richtig beantwortet hat.';
...
$string['feedback_grand_desc'] = 'Herzlichen Glückwunsch! Du hast alle Karten im System bis in den Experten-Stapel gebracht und zudem völlig fehlerfrei wiedergegeben. Du hast dieses Thema absolut verstanden!';
