...
$string['feedback_perfect_title'] = 'Hervorragend!';
$string['feedback_perfect_desc'] = 'Fast alles richtig. Du hast das Material extrem gut verstanden!';
$string['feedback_good_title'] = 'Sehr gut!';
$string['feedback_good_desc'] = 'Du bist auf einem tollen Weg. Weiter so!';
$string['feedback_okay_title'] = 'Gut gemacht!';
$string['feedback_okay_desc'] = 'Die Grundlagen sitzen. Mit ein bisschen mehr Übung wirst du zum Experten.';
$string['feedback_learn_title'] = 'Dranbleiben!';
$string['feedback_learn_desc'] = 'Übung macht den Meister. Schau dir die schweren Karten einfach nochmal an.';
