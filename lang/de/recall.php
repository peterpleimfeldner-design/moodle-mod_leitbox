...
// Privacy metadata.
$string['privacy:metadata:recall_progress'] = 'Informationen über den Lernfortschritt bei Recall-Karten.';
...
$string['known_btn'] = 'Später wiederholen';
$string['known_desc'] = 'Du hast das gelernt! Diese Karte wird erst viel später wieder abgefragt.';
$string['again_btn'] = 'Nochmal lernen';
$string['again_desc'] = 'Du bist noch am Lernen. Diese Karte wird in dieser Sitzung erneut abgefragt.';
$string['hard_btn'] = 'Bald wiederholen';
$string['hard_desc'] = 'Du hast das vergessen. Diese Karte rückt zurück in Box 1 und wird bald abgefragt.';
